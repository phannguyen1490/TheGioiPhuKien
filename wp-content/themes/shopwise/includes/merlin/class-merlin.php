...
class Merlin {
	...
	protected function license() {
        if(shopwise_get_registered_purchase_code()) {
	...
	protected function plugins() {
        if(empty(shopwise_get_registered_purchase_code())) {
            echo "<p>".esc_html__('Please verify the purchase code first.','shopwise')."</p>";
	...
	public function _ajax_activate_license() {
		...
		update_option( 'envato_purchase_code_26616838', $license_key );
