 ...
 */
 ?>
	...
	<?php if(get_theme_mod('shopwise_footer_subscribe_area') == 1 && shopwise_subscribe_model_cache() != 'enabled'){ ?>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						...
						<?php } else { ?>
							<p class="mb-md-0 text-center text-md-left"><?php esc_html_e('Copyright 2021.KlbTheme . All rights reserved','shopwise'); ?></p>
						<?php } ?>
					</div>
					<div class="col-md-6">
